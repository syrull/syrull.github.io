...
I am completely new to Unity, let alone decompiling and reverse engineering (ai: is this the correct way to say this?). While I know some basic stuff, bear with me here :D.

I discovered the use of "Harmony" through [ModsGate](https://github.com/LegionTD2-Modding/ModsGate/). It was my first time hearing about this library, so I had to research it too. On top of that, I am also quite inexperienced with C# (ai: is this the right wording/grammar, I mean?).
...
(ai: Maybe use the file code component that I have in re-tzar)
```csharp
# HudInstaller.cs
using System;
...
(ai: maybe the logic here is a bit lost)
